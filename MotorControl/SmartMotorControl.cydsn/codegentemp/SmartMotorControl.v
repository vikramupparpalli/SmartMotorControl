...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=0, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=0, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=100, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=LidarMotorControl, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LidarMotorControl, CY_INSTANCE_SHORT_NAME=LidarMotorControl, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=LidarMotorControl, )
...
module top ;
    ...
    TCPWM_Counter_PDL_v1_0_0 PeriodicTimer (
        .capture(1'b0),
        .clock(Net_22),
        .compare(Net_26),
        .count(1'b1),
    ...
    TCPWM_PWM_PDL_v1_0_1 MotorSpeedControl (
        .clock(Net_42),
        .compare(Net_41),
        .count(1'b1),
        .interrupt(Net_38),
	...
	wire [0:0] tmpFB_0__DcMotorSpeed_net;
	wire [0:0] tmpIO_0__DcMotorSpeed_net;
	electrical [0:0] tmpSIOVREF__DcMotorSpeed_net;
	...
	cy_mxs40_gpio_v1_0
		...
		DcMotorSpeed
		 (.oe({1'b1}),
		  .y({Net_45}),
		  .fb({tmpFB_0__DcMotorSpeed_net[0:0]}),
		  .io({tmpIO_0__DcMotorSpeed_net[0:0]}),
		  .siovref(tmpSIOVREF__DcMotorSpeed_net));
    ...
    TCPWM_PWM_PDL_v1_0_2 ServoControl (
        .clock(Net_48),
        .compare(Net_49),
        .count(1'b1),
        .interrupt(Net_51),
	...
	wire [0:0] tmpFB_0__ServoPositionControl_net;
	wire [0:0] tmpIO_0__ServoPositionControl_net;
	electrical [0:0] tmpSIOVREF__ServoPositionControl_net;
	...
	cy_mxs40_gpio_v1_0
		...
		ServoPositionControl
		 (.oe({1'b1}),
		  .y({Net_54}),
		  .fb({tmpFB_0__ServoPositionControl_net[0:0]}),
		  .io({tmpIO_0__ServoPositionControl_net[0:0]}),
		  .siovref(tmpSIOVREF__ServoPositionControl_net));
    ...
    TCPWM_PWM_PDL_v1_0_3 LidarMotorControl (
        .clock(Net_68),
        .compare(Net_69),
        .count(1'b1),
        .interrupt(Net_71),
	...
	wire [0:0] tmpFB_0__LidarMotorSpeed_net;
	wire [0:0] tmpIO_0__LidarMotorSpeed_net;
	electrical [0:0] tmpSIOVREF__LidarMotorSpeed_net;
	...
	cy_mxs40_gpio_v1_0
		...
		LidarMotorSpeed
		 (.oe({1'b1}),
		  .y({Net_74}),
		  .fb({tmpFB_0__LidarMotorSpeed_net[0:0]}),
		  .io({tmpIO_0__LidarMotorSpeed_net[0:0]}),
		  .siovref(tmpSIOVREF__LidarMotorSpeed_net));
	...
	wire [0:0] tmpFB_0__DirectionInput1_net;
	wire [0:0] tmpIO_0__DirectionInput1_net;
	electrical [0:0] tmpSIOVREF__DirectionInput1_net;
	...
	cy_mxs40_gpio_v1_0
		...
		DirectionInput1
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__DirectionInput1_net[0:0]}),
		  .io({tmpIO_0__DirectionInput1_net[0:0]}),
		  .siovref(tmpSIOVREF__DirectionInput1_net));


	wire [0:0] tmpFB_0__DirectionInput2_net;
	wire [0:0] tmpIO_0__DirectionInput2_net;
	electrical [0:0] tmpSIOVREF__DirectionInput2_net;
	...
	cy_mxs40_gpio_v1_0
		...
		DirectionInput2
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__DirectionInput2_net[0:0]}),
		  .io({tmpIO_0__DirectionInput2_net[0:0]}),
		  .siovref(tmpSIOVREF__DirectionInput2_net));


    SCB_UART_PDL_v2_0_4 ExternalUart (
        .clock(1'b0),
        .cts_in(1'b0),
        .interrupt(Net_92),
        .rts_out(Net_91),
